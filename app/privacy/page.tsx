        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              We only collect what&apos;s necessary for basic app functionality.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-white/70 leading-relaxed space-y-3">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong>Crash reports</strong> — to help us fix bugs and improve the app</li>
              </ul>
              <p className="mt-4 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                We do <strong>NOT</strong> collect or access your workout data, exercise history, or personal records. These never leave your device.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-white/70 leading-relaxed space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong>Apple</strong> — HealthKit integration (optional)</li>
              </ul>
              <p className="mt-4">
